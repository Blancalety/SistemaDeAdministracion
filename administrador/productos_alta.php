...
<body>
    ...
    <form class='form' enctype="multipart/form-data" name="Forma01" action="productos_salva.php" method="post" id="form1">
        <div class="caja">
            <span>Nombre </span><br>
            <input type="text" name="nombre" id="nombre" placeholder="Nombre del producto" autocomplete="off"><br>
        </div>
        <div class="caja">
            <span>Codigo </span><br>
        ...
        <div class="caja">
            ...
            <textarea name="descripcion" id="descripcion" class="large-textarea"placeholder="Escribe la descripcion" autocomplete="off"></textarea><br>
        </div>
        <div class="caja">
            <span>Costo</span><br>
            <input type="text" name="costo" id="costo" placeholder="Costo" autocomplete="off"><br>
        </div>
        <div class="caja">
            <span>Stock</span><br>
            <input type="text" name="stock" id="stock" placeholder="Cantidad en stock" autocomplete="off"><br>
        </div>
        <div class="caja">
