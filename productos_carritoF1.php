...
<?php
    ...
    <a href="bienvenido_cliente.php" class="link botonlista">Seguir agregando</a><br><br>
...
<script type="text/javascript">
    ...
    $('#botonCesta').click(function(e) {
        ...
        $.ajax({
            type: 'GET',
            url: 'productos_carrito_salvaF1.php', // La URL del archivo PHP que contiene el código para manejar la actualización del estado del pedido
